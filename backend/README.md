...
## Project Structure
    ...
    ├── testing_realestatem_38782  # Django project configurations
...
1. Clone this repo and `cd testing_realestatem_38782`
...
2. Clone this repo and `cd testing_realestatem_38782`
